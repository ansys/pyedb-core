...
class PackageDef(ObjBase):
    ...
    @classmethod
    def create(cls, db: Database, name: str) -> PackageDef:
    ...
    @classmethod
    def find_by_name(cls, db: Database, name: str) -> PackageDef:
    ...
    @classmethod
    def find_by_id(cls, db: Database, uid: int) -> PackageDef:
    ...
    def exterior_boundary(self, boundary: PolygonData):
        self.__stub.SetExteriorBoundary(polygon_data_property_message(self, boundary))

    @property
    def height(self) -> Value:
        """:term:`ValueLike`: Height of the package."""
    ...
    @heat_sink.setter
    def heat_sink(self, heat_sink_value: HeatSink):
