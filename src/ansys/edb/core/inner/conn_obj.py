...
class _QueryBuilder:
    ...
    def find_id_layout_obj_message(layout, type, id):
        return connectable_pb2.FindByIdLayoutObjMessage(
            layout=layout.msg, type=type.value, id_msg=edb_internal_id_message(id)
        )
...
class ConnObj(LayoutObj):
    ...
    def _validate_edb_obj_type(cls, edb_obj_msg):
        ...
        if cls.layout_obj_type == LayoutObjType.PRIMITIVE:
            ...
            import ansys.edb.core.terminal.terminals as terminal
    ...
    def group(self, group):
        ...
        self.__stub.SetGroup(pointer_property_message(target=self, value=group))
    ...
    def create_stride(self):
        ...
        return McadModel.create_stride(connectable=self)
    ...
    def create_hfss(self):
        ...
        return McadModel.create_hfss(connectable=self)
    ...
    def create_3d_comp(self):
        ...
        return McadModel.create_3d_comp(connectable=self)
    ...
    def is_mcad_stride(self):
        ...
        return McadModel.is_mcad_stride(self)
    ...
    def is_mcad_hfss(self):
        ...
        return McadModel.is_mcad_hfss(self)
    ...
    def is_mcad_3d_comp(self):
        ...
        return McadModel.is_mcad_3d_comp(self)
