...
class SharedMemoryTransport:
    ...
    def __init__(self, shm_name: str, shm_size_mb: int = 0):
    ...
    def _spin_wait_for_response(self):
        ...
        # Hot loop: read the 4-byte state field directly from the memoryview.
        # struct.unpack_from is used for each read to get a fresh value from
        # the memory-mapped region (the OS guarantees coherence for shared
        # memory backed by the same physical pages).
        while True:
            # Phase 1: tight spin
