...
from ansys.edb.core.core import ObjBase, VariableServer, messages
...
class Cell(ObjBase, VariableServer):
    ...
    def find(cls, database, cell_type, name=None, cell_id=None):
        ...
        Parameters
        ----------
        database : ansys.edb.core.database.Database
        cell_type : CellType
        name : str, optional
    ...
    def cutout(self, included_nets, clipped_nets, clipping_polygon, clean_clipping):
        ...
        Parameters
        ----------
        included_nets : list[ansys.edb.core.net.Net]
        clipped_nets : list[ansys.edb.core.net.Net]
        clipping_polygon : ansys.edb.core.geometry.PolygonData
        clean_clipping : bool
    ...
    def add_simulation_setup(self, setup_type, name, sim_setup):
        ...
        Parameters
        ----------
        setup_type : ansys.edb.core.simulation_setup.simulation_setup.SimulationSetupType
        name : str
        sim_setup : str
        """
