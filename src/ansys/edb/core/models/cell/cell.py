...
from ..hfss_extent_info import HfssExtentInfo
from ..simulation_setup.simulation_setup import SimulationSetup
from ..temperature_settings import TemperatureSettings
...
class Cell(ObjBase, _VariableServer):
    ...
    def find(cls, database, cell_type, name=None, cell_id=None):
        ...
        Parameters
        ----------
        database : ansys.edb.core.models.database.Database
        cell_type : CellType
        name : str, optional
    ...
    def database(self):
        ...
        Returns
        -------
        ansys.edb.core.models.database.Database
        """
    ...
    def cutout(self, included_nets, clipped_nets, clipping_polygon, clean_clipping):
        ...
        Parameters
        ----------
        included_nets : list[ansys.edb.core.models.cell.net.Net]
        clipped_nets : list[ansys.edb.core.models.cell.net.Net]
        clipping_polygon : ansys.edb.core.models.polygon_data.PolygonData
        clean_clipping : bool
    ...
    def add_simulation_setup(self, setup_type, name, sim_setup):
        ...
        Parameters
        ----------
        setup_type : ansys.edb.core.models.simulation_setup.simulation_setup.SimulationSetupType
        name : str
        sim_setup : str
        """
