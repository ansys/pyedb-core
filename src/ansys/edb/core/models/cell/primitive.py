...
class Primitive(ConnObj):
    ...
    @handle_grpc_exception
    def add_void(self, hole: "Primitive") -> bool:
        return get_primitive_stub().AddVoid(_PrimitiveQueryBuilder.add_void(self, hole)).value

    @handle_grpc_exception
    def set_hfss_prop(self, material: str, solve_inside: bool) -> bool:
        return (
            get_primitive_stub()
    ...
    @handle_grpc_exception
    def set_layer(self, layer: Layer) -> bool:
    ...
    @handle_grpc_exception
    def set_is_negative(self, is_negative: bool) -> bool:
        return (
            get_primitive_stub()
    ...
    @handle_grpc_exception
    def remove_hfss_prop(self) -> bool:
...
class Rectangle(Primitive):
    ...
    @handle_grpc_exception
    def render(
        representation_type: RectangleRepresentationType,
        ...
        if representation_type == Rectangle.RectangleRepresentationType.LOWER_LEFT_UPPER_RIGHT:
        ...
        elif representation_type == Rectangle.RectangleRepresentationType.CENTER_WIDTH_HEIGHT:
            polygon_data = get_rectangle_stub().Render(
                rectangle_pb2.RectanglePolygonDataMessage(
...
class Polygon(Primitive):
    @staticmethod
    @handle_grpc_exception
    def create(layout, layer_name: str, net, polygon_data):
        return Polygon(
