...
class ApdBondwireDef(BondwireDef):
    ...
    def create(database, name):
        """Create a apd bondwire definition.
    ...
    def find_by_name(database, name):
        """Find apd bondwire definition by name.
    ...
    def get_parameters(self):
        """Get parameters of apd bondwire definition.
    ...
    def set_parameters(self, name):
        """Set parameters of apd bondwire definition.
...
class Jedec4BondwireDef(ObjBase):
    """Class representing an jedec 4 bondwire definition."""
    ...
    @handle_grpc_exception
    def find_by_name(database, name):
        """Find jedec 4 bondwire definition by name.
    ...
    @handle_grpc_exception
    def get_parameters(self):
        """Get parameters of jedec 4 bondwire definition.
    ...
    def set_parameters(self, parameter):
        """Set parameters of jedec 4 bondwire definition.
...
class Jedec5BondwireDef(BondwireDef):
    ...
    @handle_grpc_exception
    def find_by_name(database, name):
        """Find jedec 5 bondwire definition by name.
    ...
    @handle_grpc_exception
    def get_parameters(self):
        """Get parameters of jedec 5 bondwire definition.
    ...
    def set_parameters(self, ttd, dpa, lpa):
        """Set parameters of jedec 5 bondwire definition.
