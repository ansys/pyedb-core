...
class MaterialPropertyThermalModifier(ObjBase):
    ...
    def create(cls, basic_quadratic_params=None, advanced_quadratic_params=None):
        ...
        Parameters
        ----------
        basic_quadratic_params: :class:`BasicQuadraticParams <ansys.edb.utility.BasicQuadraticParams>`
            Thermal Modifier basic parameters needed.
        advanced_quadratic_params : :class:`AdvancedQuadraticParams <ansys.edb.utility.AdvancedQuadraticParams>`
    ...
    def quadratic_model_params(self):
        """:class:`BasicQuadraticParams <ansys.edb.utility.BasicQuadraticParams>`, \
        :class:`AdvancedQuadraticParams <ansys.edb.utility.AdvancedQuadraticParams>`: Quadratic model parameters of \
    ...
    @property
    def expression(self):
        """:class:`Value <ansys.edb.utility.Value>`: Expression value representing the thermal modifier.
