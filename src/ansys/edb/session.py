...
from ansys.api.edb.v1.dielectric_material_model_pb2_grpc import (
    DebyeModelServiceStub,
    DielectricMaterialModelServiceStub,
    DjordjecvicSarkarModelService,
    MultipoleDebyeModelServiceStub,
)
...
class StubType(Enum):
    ...
    djordecvic_sarkar_model = DjordjecvicSarkarModelService
