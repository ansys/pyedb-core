...
from ansys.edb.core.simulation_setup.siwave_psi_simulation_setup import SIwavePSISimulationSetup
...
with session(ANSYS_EM_ROOT, 50056):
    try:
        ...
        # psi_sim_setup = SIwavePSISimulationSetup.create(cell, "SIwavePSI1")
        # psi_sim_settings = psi_sim_setup.settings
        # general = psi_sim_settings.general
        
        # print(general.min_plane_area_to_mesh)
        # general.min_plane_area_to_mesh = "0.15mm2"
        # print(general.min_plane_area_to_mesh)
        ...
        general.use_auto_mesh_region = False
        print(general.use_auto_mesh_region)
